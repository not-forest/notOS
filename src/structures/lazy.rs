...
use super::FI_PREVENTION_PATTERN as lazyInit;
...
macro_rules! single {
    (
        ...
        $(#[$meta])*
        $(
            static $name: $crate::structures::lazy::Single<$type, fn() -> $type> = $crate::structures::lazy::Single::new(|| $init);
        )+
    };
    (
        $(#[$meta:meta])*
        ...
        $(#[$meta])*
        $(
            pub static $name: $crate::structures::lazy::Single<$type, fn() -> $type> = $crate::structures::lazy::Single::new(|| $init);
        )+
    };
    (
        $(#[$meta:meta])*
        ...
        $(#[$meta])*
        $(
            pub static mut $name: $crate::structures::lazy::Single<$type, fn() -> $type> = $crate::strctures::lazy::Single::new(|| $init);
        )+
    };
    (
        $(#[$meta:meta])*
        ...
        $(#[$meta])*
        $(
            pub static mut $name: $crate::structures::lazy::Single<$type, fn() -> $type> = $crate::structures::lazy::Single::new(|| $init);
        )+
    };
    () => ();
}
