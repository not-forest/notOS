...
#![feature(custom_test_frameworks, used_with_arg, ptr_metadata, slice_from_ptr_range,
    generic_const_exprs, allocator_api, slice_ptr_get, maybe_uninit_array_assume_init, map_try_insert,
    abi_x86_interrupt, type_alias_impl_trait, tuple_trait, unboxed_closures)]
...
pub mod kernel_components {
    ...
    pub mod arch_x86_64 {
        ...
        pub mod controllers {
            ...
            pub mod rtc;
            /// Programmable Interval Timer management.
            pub mod pit;
